...
const About = () => {
  return (
    <>
      <AppNavBar/>
      <div className="about relative min-h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center md:px-40 mt-0" style={{backgroundImage: `url(${img6})`}}>
        <div className="text-white text-center px-4 max-h-[50%]">
          <h2 className="text-3xl font-bold mb-4">ABOUT US</h2>
          <p className="text-sm mb-6">At Outfit Match Generator, we believe that fashion is an expression of individuality and personality.
          ...
          <p className="text-sm mb-6">We empower your fashion journey with seamless outfit matching. Our
          ...
          <p className="text-sm mb-6">Our diverse team merges fashion, tech, and creativity to redefine fashion's
